 ...
 *
 * Not static: platform_linux.c also calls this directly to retry a path
 * whose earlier synchronous re-add failed once its underlying netlink event
 * has already fired and won't repeat (see netlink_mon.h). */
int
