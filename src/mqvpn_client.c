...
static int
init_xquic_engine(mqvpn_client_t *c, const mqvpn_config_t *cfg)
{
    ...
    if (xqc_engine_get_default_config(&xconfig, XQC_ENGINE_CLIENT) < 0) return -1;
    ...
    if (xqc_h3_ctx_init(c->engine, &h3_cbs) != XQC_OK) return -1;
