...
mqvpn_apply_scheduler(xqc_conn_settings_t *cs, mqvpn_scheduler_t sched)
{
    ...
    case MQVPN_SCHED_REDUNDANT: cs->scheduler_callback = xqc_redundant_scheduler_cb; break;
    case MQVPN_SCHED_DSCP: cs->scheduler_callback = xqc_dscp_scheduler_cb; break;
...
mqvpn_build_conn_settings(const mqvpn_conn_settings_input_t *in, xqc_conn_settings_t *out)
{
    ...
    case MQVPN_CC_NEW_RENO:
        ...
        out->cong_ctrl_callback = xqc_reno_cb;
#else
    ...
    case MQVPN_CC_COPA:
        ...
        out->cong_ctrl_callback = xqc_copa_cb;
#else
        out->cong_ctrl_callback = xqc_bbr2_cb;
#endif
        break;
